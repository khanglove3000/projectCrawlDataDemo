...
class ReviewspiderSpider(scrapy.Spider):
    ...
    custom_settings = {'FEED_URI': 'amazon/outputfile.json', 'CLOSESPIDER_TIMEOUT' : 15} # This will tell scrapy to store the scraped data to outputfile.json and for how long the spider should run.
